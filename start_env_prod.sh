...
docker-compose -f docker-compose.yml up -d nginx data_migrants data_pa data_ngo watchtower
...
docker-compose -f docker-compose.yml up -d db_admin
...
docker-compose -f docker-compose.yml up -d git weblate cache
